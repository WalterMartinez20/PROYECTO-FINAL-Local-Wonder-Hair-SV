...
btn_adelante2.addEventListener("click", function(e){
    ...
    if (correos=="" && contras==""){
        ...
        document.getElementById("contra").style.borderColor = "#26bfbf66"
        ...
        if ( contras=="" ){
            ...
            document.getElementById("contra-error").innerHTML = "* Minimo 8 caracteres."
            document.getElementById("contra").style.borderColor="#DA2A33"      
        }else if ( !verificarcontra(contras) ){
            document.getElementById("contra-error").innerHTML = "* Mínimo una letra mayúscula, una letra minúscula, un número y un carácter especial."
            document.getElementById("contra").style.borderColor="#DA2A33"      
        }else {
    ...
    function verificarcontra($m){
        var ExpRegular_Num = /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%\-\/\\=*?&])[A-Za-z\d@$!%\-\/\\=*?&]{8,}$/;
